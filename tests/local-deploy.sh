...
DEPLOY_ARGS="provider=local server=10.0.8.100 ssh_user=ubuntu endpoint=10.0.8.100 ondemand_cellular=true ondemand_wifi=true ondemand_wifi_exclude=test store_pki=true install_headers=false tests=true local_service_ip=172.16.0.1 dns_encryption=false"
